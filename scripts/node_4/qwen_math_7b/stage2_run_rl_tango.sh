...
LOG_DIR=./logs/run_qwen_math_7b_${TIMESTAMP}
mkdir -p $LOG_DIR

export VERL_DEBUG_LEVEL=DEBUG   # Set the debug level to "DEBUG"
export VERL_LOG_FILE=$LOG_DIR/rltango_training_qwen_math_7b.log  # Configure the log file path
...
EXPERIMENT_NAME='rl-tango-training-qwen-math-7b'
