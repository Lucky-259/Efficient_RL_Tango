...
output_paths=(./data/eurus2_sft_math/deepseek_r1_distill_llama70b_sft_data_generation.parquet)
model_path=${your_base_models_path}/DeepSeek-R1-Distill-Llama-70B
prompt_length=1024
